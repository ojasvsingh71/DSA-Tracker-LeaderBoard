    ...
    try {
        ...
        const leaderboard = group.students.map(student => {
            ...
            return {
                ...
                codechefHandle: codechefData?.handle || "",
                codeforcesHandle: codeforcesData?.handle || "",
                language: leetCodeData?.language || "N/A",
                codechefLanguage: codechefData?.language || "",
                codeforcesLanguage: codeforcesData?.language || "",
